  ...
  return (
    <>
      <div className="file-edit-panel">
        ...
        <div className="file-edit-panel--item" onClick={() => onClickHandler('changeComment')} onKeyDown={() => onClickHandler('changeComment')} role="button" tabIndex={0}>Поменять комментарий</div>
        ...
        <div className="file-edit-panel--item" onClick={() => onClickHandler('getLink')} onKeyDown={() => onClickHandler('getLink')} role="button" tabIndex={0}>Ссылка для скачивания</div>
